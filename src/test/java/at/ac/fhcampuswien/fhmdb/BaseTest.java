...
public class BaseTest {
    ...
    static {
        ...
        testMoviesAscending.addAll(testMovies);
        testMoviesAscending.sort(Comparator.comparing(Movie::getTitle));
        testMoviesDescending.addAll(testMovies);
        testMoviesDescending.sort(Comparator.comparing(Movie::getTitle).reversed());
